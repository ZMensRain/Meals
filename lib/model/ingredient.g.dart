...
void _ingredientSerialize(
  ...
  writer.writeBool(offsets[1], object.isNull);
...
Ingredient _ingredientDeserialize(
  ...
  final object = Ingredient(
    ...
    unit: _IngredientunitValueEnumMap[reader.readByteOrNull(offsets[3])] ??
        Units.none,
  );
  return object;
}
...
P _ingredientDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (_IngredientunitValueEnumMap[reader.readByteOrNull(offset)] ??
          Units.none) as P;
    default:
...
extension IngredientQueryFilter
  ...
  QueryBuilder<Ingredient, Ingredient, QAfterFilterCondition> isNullEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isNull',
